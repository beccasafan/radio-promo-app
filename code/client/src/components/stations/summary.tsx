            ...
            <div className="col-sm-12 col-med-4 col-lg-3">
                <div className="card">
                    ...
                    <div className="card-footer">
                        <div className="row">
                            <div className="col"><a href="#"><i className="far fa-eye"></i></a></div>
                            <div className="col">{this.props.station.website && <a href={this.props.station.website} target="_blank"><i className="far fa-link"></i></a>}</div>
                            ...
                            <div className="col">{this.props.station.email && <a href={`mailto:${this.props.station.email}`} target="_blank"><i className="far fa-envelope"></i></a>}</div>
                            <div className="col">{this.props.station.text && <a href="#"><i className="far fa-comment"></i></a>}</div>
                            <div className="col">{this.props.station.phone && <a href="#"><i className="far fa-phone"></i></a>}</div>
                            <div className="col">{this.props.station.note && <a href="#"><i className="far fa-sticky-note"></i></a>}</div>
                        </div>
                    </div>
                </div>
            </div>
